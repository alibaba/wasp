...
import org.apache.wasp.UnknownProtocolException;
...
class ProtobufRpcEngine implements RpcEngine {
  private static final Log LOG = LogFactory
      .getLog("org.apache.wasp.ipc.ProtobufRpcEngine");
  ...
  static class Invoker implements InvocationHandler {
    ...
    private RpcRequestBody constructRpcRequest(Method method, Object[] params)
  ...
  public static class Server extends NettyServer {
    ...
    protected static final Log TRACELOG = LogFactory
        .getLog("org.apache.wasp.ipc.NettyServer.trace");
    ...
    public Message call(Class<? extends VersionedProtocol> protocol,
        RpcRequestBody rpcRequest, long receiveTime) throws IOException {
      try {
