...
import org.apache.wasp.ClockOutOfSyncException;
import org.apache.wasp.DaemonThreadFactory;
...
import org.apache.wasp.RemoteExceptionHandler;
import org.apache.wasp.ServerName;
import org.apache.wasp.UnknownScannerException;
import org.apache.wasp.YouAreDeadException;
import org.apache.wasp.ZNodeClearer;
...
import org.apache.wasp.fserver.handler.CloseEntityGroupHandler;
import org.apache.wasp.fserver.handler.OpenEntityGroupHandler;
import org.apache.wasp.fserver.metrics.MetricsFServer;
import org.apache.wasp.fserver.metrics.MetricsFServerWrapper;
import org.apache.wasp.ipc.NettyServer;
import org.apache.wasp.ipc.RpcServer;
import org.apache.wasp.ipc.ServerNotRunningYetException;
import org.apache.wasp.ipc.WaspRPC;
import org.apache.wasp.ipc.WaspRPCErrorHandler;
import org.apache.wasp.master.FServerStatusProtocol;
...
import org.apache.wasp.plan.BaseDriver;
...
import org.apache.wasp.protobuf.generated.FServerAdminProtos.CloseEncodedEntityGroupRequest;
import org.apache.wasp.protobuf.generated.FServerAdminProtos.CloseEncodedEntityGroupResponse;
...
import org.apache.wasp.protobuf.generated.FServerAdminProtos.StopServerRequest;
import org.apache.wasp.protobuf.generated.FServerAdminProtos.StopServerResponse;
...
import org.apache.wasp.protobuf.generated.WaspProtos.EntityGroupInfoProtos;
import org.apache.wasp.protobuf.generated.WaspProtos.EntityGroupLoadProtos;
import org.apache.wasp.protobuf.generated.WaspProtos.EntityGroupOpeningState;
import org.apache.wasp.protobuf.generated.WaspProtos.StringStringPair;
import org.apache.wasp.storage.StorageActionManager;
import org.apache.wasp.util.InfoServer;
import org.apache.wasp.zookeeper.ClusterStatusTracker;
import org.apache.wasp.zookeeper.MasterAddressTracker;
import org.apache.wasp.zookeeper.ZKClusterId;
import org.apache.wasp.zookeeper.ZKUtil;
import org.apache.wasp.zookeeper.ZooKeeperNodeTracker;
...
public class FServer implements ClientProtocol, AdminProtocol, Runnable,
  ...
  private void startServiceThreads() throws IOException {
    ...
    this.service.startExecutorService(ExecutorType.FSERVER_OPEN_ENTITYGROUP,
        conf.getInt("wasp.fserver.executor.openentitygroup.threads", 3));
    this.service.startExecutorService(ExecutorType.FSERVER_CLOSE_ENTITYGROUP,
  ...
  protected void handleReportForDutyResponse(final FServerStartupResponse c)
      throws IOException {
    try {
      for (StringStringPair e : c.getMapEntriesList()) {
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#execute(com.google.protobuf.RpcController,
  ...
  public ExecuteResponse execute(RpcController controller,
    ...
    ReadModelProto readModel = request.getReadModel();
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#get(com.google.protobuf.RpcController,
   ...
   * @throws ServiceException
   */
  public GetResponse get(byte[] entityGroupName, GetAction getAction)
      throws ServiceException {
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#scan(com.google.protobuf.RpcController,
   ...
   * @throws ServiceException
   */
  public ScanResponse scan(byte[] entityGroupName, ScanAction scanAction,
  ...
  public ScanResponse scan(byte[] entityGroupName, ScanAction scanAction,
    ...
    try {
      ...
      try {
        ...
        return ResponseConverter.buildScanResponse(builder,
            scanAction.getColumns());
      } catch (Exception t) {
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#insert(com.google.protobuf.RpcController,
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#update(com.google.protobuf.RpcController,
  ...
  /**
   * @see org.apache.wasp.client.ClientProtocol#delete(com.google.protobuf.RpcController,
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#getEntityGroupInfo(com.google.protobuf.RpcController,
  ...
  public GetEntityGroupInfoResponse getEntityGroupInfo(
    ...
    GetEntityGroupInfoResponse.Builder builder = GetEntityGroupInfoResponse
        .newBuilder();
    try {
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#getOnlineEntityGroups(com.google.protobuf.RpcController,
  ...
  public GetOnlineEntityGroupsResponse getOnlineEntityGroups(
    ...
    try {
      checkOpen();
      GetOnlineEntityGroupsResponse.Builder builder = GetOnlineEntityGroupsResponse
          .newBuilder();
      for (Map.Entry<String, EntityGroup> e : this.onlineEntityGroups
          .entrySet()) {
        builder
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#openEntityGroups(com.google.protobuf.RpcController,
  ...
  public OpenEntityGroupsResponse openEntityGroups(RpcController controller,
    ...
    for (EntityGroupInfoProtos entityGroupInfo : request
    ...
    OpenEntityGroupsResponse.Builder builder = OpenEntityGroupsResponse
        .newBuilder();
    return builder.build();
  }
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#openEntityGroup(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.OpenEntityGroupRequest)
   */
  @Override
  public OpenEntityGroupResponse openEntityGroup(RpcController controller,
      OpenEntityGroupRequest request) throws ServiceException {
    try {
      checkOpen();
    } catch (IOException ie) {
      throw new ServiceException(ie);
    ...
    OpenEntityGroupResponse.Builder builder = OpenEntityGroupResponse
        .newBuilder();
    ...
    for (EntityGroupInfoProtos entityGroupOpenInfo : request
      ...
      try {
        ...
        if (isBulkAssign) {
          builder.addOpeningState(EntityGroupOpeningState.FAILED_OPENING);
        } else {
          throw new ServiceException(ie);
        }
      }
  ...
  private EntityGroupOpeningState openEntityGroup(EntityGroupInfo entityGroup,
      int versionOfOfflineNode) throws IOException {
    return openEntityGroupWithTableBuffer(entityGroup, versionOfOfflineNode,
        null);
  }

  private EntityGroupOpeningState openEntityGroupWithTableBuffer(
    ...
    if (null != onlineEntityGroup) {
      ...
      if (this.getServerName().equals(p.getSecond())) {
        ...
        return EntityGroupOpeningState.ALREADY_OPENED;
      } else {
    ...
    return EntityGroupOpeningState.OPENED;
  }
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#closeEntityGroup(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.CloseEntityGroupRequest)
   */
  @Override
  public CloseEntityGroupResponse closeEntityGroup(RpcController controller,
    ...
    EntityGroupInfoProtos entityGroupInfoProto = request.getEntityGroup();
    ...
    LOG.info("Received close entityGroup: "
        ...
        + NettyServer.getRemoteAddress());
    CloseEntityGroupResponse.Builder builder = CloseEntityGroupResponse
        .newBuilder();
    try {
  ...
  /**
   * @see org.apache.wasp.protobuf.generated.FServerAdminProtos.FServerAdminService.BlockingInterface#closeEncodedEntityGroup(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.CloseEncodedEntityGroupRequest)
   */
  @Override
  public CloseEncodedEntityGroupResponse closeEncodedEntityGroup(
      RpcController controller, CloseEncodedEntityGroupRequest request)
      throws ServiceException {
    CloseEncodedEntityGroupResponse.Builder builder = CloseEncodedEntityGroupResponse
        .newBuilder();
    try {
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#splitEntityGroup(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.SplitEntityGroupRequest)
   */
  @Override
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#disableServerTable(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.DisableTableRequest)
   *      (com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.
  ...
  public DisableTableResponse disableServerTable(RpcController controller,
    ...
    try {
      ...
      DisableTableResponse.Builder builder = DisableTableResponse.newBuilder();
  ...
  /**
   * @see org.apache.wasp.fserver.AdminProtocol#enableServerTable(com.google.protobuf.RpcController,
  ...
  public EnableTableResponse enableServerTable(RpcController controller,
    ...
    try {
      ...
      EnableTableResponse.Builder buider = EnableTableResponse.newBuilder();
  ...
  private EntityGroupLoad createEntityGroupLoad(EntityGroup entityGroup) {
    EntityGroupLoadProtos.Builder builder = EntityGroupLoadProtos.newBuilder();
  ...
  /**
   * @see org.apache.wasp.fserver.FServerServices#getLeases()
   */
  @Override
   ...
   * @throws IOException
   */
  public UpdateResponse update(byte[] entityGroupName, UpdateAction updateAction)
      throws IOException {
    long before = EnvironmentEdgeManager.currentTimeMillis();
    EntityGroup entityGroup = getEntityGroup(entityGroupName);
   ...
   * @throws IOException
   */
  public DeleteResponse delete(byte[] entityGroupName, DeleteAction deleteAction)
      throws IOException {
    long before = EnvironmentEdgeManager.currentTimeMillis();
    EntityGroup entityGroup = getEntityGroup(entityGroupName);
   ...
   * @throws IOException
   */
  public InsertResponse insert(byte[] entityGroupName, InsertAction insertAction)
      throws IOException {
    long before = EnvironmentEdgeManager.currentTimeMillis();
    EntityGroup entityGroup = getEntityGroup(entityGroupName);
  ...
  /**
   * @see org.apache.wasp.protobuf.generated.FServerAdminProtos.FServerAdminService.BlockingInterface#getServerInfo(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.GetServerInfoRequest)
   */
  @Override
  ...
  /**
   * @see org.apache.wasp.protobuf.generated.FServerAdminProtos.FServerAdminService.BlockingInterface#stopServer(com.google.protobuf.RpcController,
   *      org.apache.wasp.protobuf.generated.FServerAdminProtos.StopServerRequest)
   */
  @Override
  public StopServerResponse stopServer(RpcController controller,
    ...
    LOG.info(message);
    this.stop(message);
    StopServerResponse.Builder builder = StopServerResponse.newBuilder();
    return builder.build();
  }
