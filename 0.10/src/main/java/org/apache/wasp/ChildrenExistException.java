 ...
 */
public class ChildrenExistException extends ClientConcernedException {
   ...
   *          message
   */
  public ChildrenExistException(String s) {
    super(s);
  }

  /**
   * @param tableName
   *          Name of table that is not enabled
   */
  public ChildrenExistException(byte[] tableName) {
