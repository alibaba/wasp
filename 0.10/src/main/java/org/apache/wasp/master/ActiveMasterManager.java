 ...
 * 
 * <p>
 * This class is instantiated in the FMaster constructor and the method
    ...
    while (true) {
      ...
      try {
        ...
        if (MasterAddressTracker.setMasterAddress(this.watcher,
          ...
          // Save the znode in a file, this will allow to check if we crash in
          // the launch scripts
        ...
        MasterAddressTracker.setMasterAddress(this.watcher, backupZNode,
            this.sn);
      ...
      synchronized (this.clusterHasActiveMaster) {
        ...
        if (!clusterStatusTracker.isClusterUp()) {
          this.master
              .stop("Cluster went down before this master became active");
        }
