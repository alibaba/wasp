...
public class RedoLog extends Redo {
  ...
  /**
   * 
   * @see com.alibaba.wasp.fserver.redo.Redo#initlize()
   */
   ...
   * @see com.alibaba.wasp.fserver.redo.Redo#peekLastUnCommitedTransaction()
   */
  @Override
  ...
  /**
   * @see com.alibaba.wasp.fserver.redo.Redo#redo()
   */
  @Override
  ...
  /**
   * @see com.alibaba.wasp.fserver.redo.Redo#size()
   */
  @Override
  public int size() {
