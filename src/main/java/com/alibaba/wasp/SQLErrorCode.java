...
public class SQLErrorCode {
  ...
  /**
   * The error with code <code>57014</code> is thrown when a statement was
   * canceled using Statement.cancel() or when the query timeout has been
   * reached. Examples:
   * 
   * <pre>
  ...
  /**
   * The error with code <code>90101</code> is thrown when the XA API detected
   * unsupported transaction names. This can happen when mixing application
   * generated transaction names and transaction names generated by this
   * databases XAConnection API.
   */
  ...
  /**
   * The error with code <code>90161</code> with error query condition
   */
  public static final int QUERY_CONDITION_ERROR = 90161;

  /**
   * The error with code <code>90170</code> is thrown when operating a not
   * supported sql.
   */
  public static final int NOT_SUPPORTED = 90170;

  /**
   * The error with code <code>91001</code> is thrown when select for update
   * lock not exits.
   */
  public static final int SELECT_FOR_UPDATE_LOCK_NOT_EXITS = 91001;

  /**
   * The error with code <code>91002</code> is thrown when parse transaction
   * error.
   */
  public static final int PARSE_TRANSACTION_ERROR = 91002;
