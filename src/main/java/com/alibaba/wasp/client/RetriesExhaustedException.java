...
/**
 * Exception thrown by Table methods when an attempt to do something (like
...
public class RetriesExhaustedException extends IOException {
   ...
   * @param callableVitals Details from the {@link com.alibaba.wasp.client.ServerCallable} we were using
