...
public class ServerName implements Comparable<ServerName> {
  ...
  public static ServerName parseFrom(final byte[] data)
    ...
    if (data == null || data.length <= 0)
      return null;
    try {
      com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName sn = com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName
          .parseFrom(data);
  ...
  public static ServerName convert(
      com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName sn) {
    if (sn == null)
      return null;
   ...
   * @return
   */
  public com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName convert() {
    com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName.Builder builder = com.alibaba.wasp.protobuf.generated.WaspProtos.ServerName
        .newBuilder();
