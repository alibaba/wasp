 ...
 * taken for assignment of a entityGroup in transition. Implementing as future
...
public class AssignCallable implements Callable<Object> {
  ...
  public AssignCallable(AssignmentManager assignmentManager, EntityGroupInfo egInfo) {
  ...
  public Object call() throws Exception {
    assignmentManager.assign(egInfo, true, true);
    return null;
  }
