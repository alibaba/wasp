...
public class InfoServer extends HttpServer {
   ...
   * The jsp scripts are taken from src/wasp-webapps/<code>name<code>.
   ...
   * @throws java.io.FileNotFoundException if 'webapps' directory cannot be found on CLASSPATH.
   */
  protected String getWebAppsPath(String appName) throws FileNotFoundException {
    // Copied from the super-class.
    String resourceName = "wasp-webapps/" + appName;
