...
import org.apache.wasp.protobuf.generated.ZooKeeperProtos.EntityGroupTransitionProtos;
...
public class EntityGroupTransaction {
  private final EntityGroupTransitionProtos egt;

  private EntityGroupTransaction(final EntityGroupTransitionProtos egt) {
    this.egt = egt;
  }
   ...
   * @param payload
   *          May be null
   * @return a serialized pb {@link EntityGroupTransitionProtos}
   * 
   */
  public static EntityGroupTransaction createEntityGroupTransition(
    ...
    EntityGroupTransitionProtos.Builder builder = EntityGroupTransitionProtos
  ...
  public static EntityGroupTransaction parseFrom(final byte[] data)
      throws DeserializationException {
    try {
      EntityGroupTransitionProtos rt = EntityGroupTransitionProtos.newBuilder()
