...
import org.apache.wasp.VersionAnnotation;

import java.io.PrintWriter;

/**
 * This class finds the package info for wasp and the VersionAnnotation
...
public class VersionInfo {
  ...
  /**
   * Get the meta-data for the wasp package.
   * @return package
   */
  ...
  /**
   * Get the wasp version.
   * @return the wasp version string, eg. "0.6.3-dev"
   */
  ...
  /**
   * The date that wasp was compiled.
  ...
  /**
   * Get the subversion URL for the root wasp directory.
   * @return the url
   */
