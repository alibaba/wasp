...
import org.apache.wasp.protobuf.generated.ClusterStatusProtos.EntityGroupInTransitionProtos;
import org.apache.wasp.protobuf.generated.ClusterStatusProtos.LiveServerInfo;
...
public class ClusterStatus {
  ...
  public ClusterStatusProtos.ClusterStatus convert() {
    ...
    for (Map.Entry<ServerName, ServerLoad> entry : liveServers.entrySet()) {
      LiveServerInfo.Builder lsi = LiveServerInfo.newBuilder().setServer(
    ...
    for (Map.Entry<String, EntityGroupState> egit : getEntityGroupsInTransition()
      ...
      ClusterStatusProtos.EntityGroupStateProtos egs = egit.getValue()
          .convert();
      EntityGroupSpecifier.Builder spec = EntityGroupSpecifier.newBuilder()
          .setType(EntityGroupSpecifierType.ENTITYGROUP_NAME);
      spec.setValue(ByteString.copyFrom(Bytes.toBytes(egit.getKey())));

      EntityGroupInTransitionProtos pbEGIT = EntityGroupInTransitionProtos
  ...
  public static ClusterStatus convert(ClusterStatusProtos.ClusterStatus proto) {
    ...
    for (EntityGroupInTransitionProtos entityGroup : proto
