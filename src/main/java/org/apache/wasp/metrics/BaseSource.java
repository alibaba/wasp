...
public interface BaseSource {
  ...
  public static final String WASP_METRICS_SYSTEM_NAME = "Wasp";
  ...
  /**
   * Get the metrics context. For hadoop metrics2 system this is usually an all
   * lowercased string. eg. fserver, master
   * 
   * @return The string context used to register this source to hadoop's
   *         metrics2 system.
   */
  ...
  /**
   * Get the name of the context in JMX that this source will be exposed
   * through. This is in ObjectName format. With the default context being
   * Hadoop -> Wasp
   */
  String getMetricsJmxContext();

  /**
   * Get the name of the metrics that are being exported by this source. Eg.
   * IPC, GC, WAL
   */
