 ...
 * under the License.
 */
package org.apache.wasp.metrics.lib;
...
public class MetricSampleQuantiles {
  ...
  /**
   * Buffers incoming items to be inserted in batch. Items are inserted into the
   * buffer linearly. When the buffer fills, it is flushed into the samples
  ...
  /**
   * Merges items from buffer into the samples array in one pass. This is more
   * efficient than doing an insert on every item.
   */
  ...
  private static class SampleItem {
    ...
    /**
     * Difference between the lowest possible rank of the previous item, and the
