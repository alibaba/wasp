 ...
 */
public class TestDefaultLoadBalancer extends TestBalancerBase {
  private static final Log LOG = LogFactory
      .getLog(TestDefaultLoadBalancer.class);
  ...
  public static void beforeAllTests() throws Exception {
    ...
    conf.set("hbase.entityGroups.slop", "0");
    loadBalancer = new DefaultLoadBalancer();
    loadBalancer.setConf(conf);
  }

  // int[testnum][servernumber] -> numentityGroups
  ...
  public void testBalanceCluster() throws Exception {
    ...
    for (int[] mockCluster : clusterStateMocks) {
      ...
      for (Map.Entry<ServerName, List<EntityGroupInfo>> entry : servers
          .entrySet()) {
