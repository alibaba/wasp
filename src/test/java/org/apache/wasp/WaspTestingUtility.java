...
import org.apache.wasp.meta.FMetaScanner.BlockingMetaScannerVisitor;
...
public class WaspTestingUtility {
  ...
  public static void adjustLogLevel() {
    Logger.getLogger("org.apache.wasp").setLevel(Level.DEBUG);
    ...
    Logger.getLogger("org.apache.wasp.ipc.ProtobufRpcEngine").setLevel(
        Level.ERROR);
    Logger.getLogger("org.apache.wasp.ipc.NettyServer.trace").setLevel(
        Level.ERROR);
