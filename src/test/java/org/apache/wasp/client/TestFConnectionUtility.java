...
/**
 * {@link org.apache.wasp.client.FConnection} testing utility.
 */
public class TestFConnectionUtility {
   ...
   */
  /**
   * Get a Mocked {@link org.apache.wasp.client.FConnection} that goes with the
   * passed <code>conf</code> configuration instance. Minimally the mock will
   * return
   * <code>conf</conf> when {@link org.apache.wasp.client.FConnection#getConfiguration()} is invoked.
   * Be sure to shutdown the connection when done by calling
   * {@link org.apache.wasp.client.FConnectionManager#deleteConnection(org.apache.hadoop.conf.Configuration, boolean)} else it
   ...
   * {@link org.apache.wasp.client.FConnection} methods so they do 'normal'
   * operation (see return doc below for list). Be sure to shutdown the
   * connection when done by calling
   * {@link org.apache.wasp.client.FConnectionManager#deleteConnection(org.apache.hadoop.conf.Configuration, boolean)}
   ...
   *         {@link org.apache.wasp.client.FConnection#getConfiguration()} is
   *         called, a 'location' when
   *         {@link org.apache.wasp.client.FConnection#getEntityGroupLocation(byte[], byte[], boolean)}
  ...
  /**
   * Get a Mockito spied-upon {@link org.apache.wasp.client.FConnection} that
