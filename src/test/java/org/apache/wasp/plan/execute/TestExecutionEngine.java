...
import org.apache.wasp.util.ResultInHBasePrinter;
...
public class TestExecutionEngine {
  ...
  public void testExecInsertPlan() throws ServiceException, IOException {
    ...
    for (WriteResultProto writeResultProto : writeResultProtos) {
      assertTrue(writeResultProto.getCode() == WriteResultProto.StatusCode.SUCCESS);
    }
  }
